	...
	<div class="search">
		<form method="post"
			...
			<span>商品名称：</span> <input name="productName" type="text"
				...
				href="${pageContext.request.contextPath }/bill/billAdd">添加订单</a>
		</form>
	</div>
	<!--账单表格 样式和供应商公用-->
