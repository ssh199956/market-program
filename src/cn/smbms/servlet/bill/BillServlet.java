...
public class BillServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * String totalPrice = request.getParameter("totalPrice"); //23.234 45
		 * BigDecimal totalPriceBigDecimal = //设置规则，小数点保留两位，多出部分，ROUND_DOWN 舍弃
		 * //ROUND_HALF_UP 四舍五入(5入) ROUND_UP 进位 //ROUND_HALF_DOWN 四舍五入（5不入） new
		 * BigDecimal(totalPrice).setScale(2,BigDecimal.ROUND_DOWN);
		 */
